...
namespace Delivery
{
    public partial class Vechicle_Mgt : Form
    {
        ...
        {
            LoadToDatagridview(dgvVechicle, "SELECT VehicleNumber as VehicleNumber ,Capacity,OilLeters as OilLeters FROM vehicle");
            LoadToDatagridview(dgvSuppliers, "SELECT Name,Address FROM supplier");
            LoadToDatagridview(dgvLeasing, "SELECT VehicleNumber as VehicleNumber,EndDate as EndDate,Balance FROM leasing_details");
            LoadToDatagridview(dgvCustomer, "SELECT c.address1 as Company,d.address as Address,i.deliverDate as DeliveryDate,d.phoneNo as PhoneNo FROM customer c,invoice i,deliverydetails d");
            LoadToDatagridview(dgvService, "SELECT VehicleNumber as VehicleNumber,NextSerDate as NextService   FROM service_details");
            LoadToDatagridview(dataGridView1, "SELECT VehicleNumber as VehicleNumber,totCost as TotalCost FROM to_customers");
            LoadToDatagridview(dagvSupmy, "SELECT SupplierName as SupplierName ,VehicleNumber as VehicleNumber, totCost as TotalCost FROM from_suppliers");
            LoadvechileNo();
            LoadDriver();
            LoadDriverSup();
        }
        ...
        private void btn_saveC_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                try
                {
                    ...
                    string Query = null;
                    Query = "INSERT INTO to_customers(CustomerName,CustomerAddress,Date,Time,StockWeight,NoOfTurn,VehicleNumber,Staffid,Distance,costPerKm,totCost)" +
                        "VALUES(@CustomerName,@CustomerAddress,@Date,@Time,@StockWeight,@NoOfTurn,@VehicleNumber,@Staffid,@Distance,@costPerKm,@totCost);";
                    ...
                    using (MySqlCommand cmd = new MySqlCommand(Query, conn))
                    {
                        ...
                        cmd.Parameters.Add("@ServiceType", MySqlDbType.VarChar).Value = (comboBoxServiT.Text);
                        cmd.Parameters.Add("@Staffid", MySqlDbType.VarChar).Value = (comboBoxCustomer.Text);
                        cmd.Parameters.Add("@Distance", MySqlDbType.Double).Value =Convert.ToDouble( textBoxdistanceC.Text);
                        cmd.Parameters.Add("@costPerKm", MySqlDbType.Double).Value = Convert.ToDouble(textBoxCostKm.Text);
                        cmd.Parameters.Add("@totCost", MySqlDbType.Double).Value = Convert.ToDouble(textBoxCostC.Text);
                        ...
                        try
                        {
                            ...
                            LoadToDatagridview(dataGridView1, "SELECT * FROM to_customers");
        ...
        private void btn_saveS_Click_1(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                try
                {
                    ...
                    string Query = null;
                    Query = "INSERT INTO from_suppliers(SupplierName,SupplierAddress,Date,Time,StockWeight,NoOfTurn,VehicleNumber,Staffid,Distance,costPerKm,totCost)" +
                        "VALUES(@SupplierName,@SupplierAddress,@Date,@Time,@StockWeight,@NoOfTurn,@VehicleNumber,@Staffid,@Distance,@costPerKm,@totCost);";
                    ...
                    using (MySqlCommand cmd = new MySqlCommand(Query, conn))
                    {
                        ...
                        cmd.Parameters.Add("@Distance", MySqlDbType.Double).Value = Convert.ToDouble(textBoxDisSup.Text);
                        cmd.Parameters.Add("@costPerKm", MySqlDbType.Double).Value = Convert.ToDouble(textBoxCostPerKmSup.Text);
                        cmd.Parameters.Add("@totCost", MySqlDbType.Double).Value = Convert.ToDouble(textBoxTotCostSup.Text);
        ...
        public void LoadvechileNo()
        {
            ...
            string query = "select VehicleNumber from vehicle";
            MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        private void dgvLeasing_CellClick(object sender, DataGridViewCellEventArgs e)
        {
           MySqlConnection conn = new MySqlConnection(connString);
            ...
            try
            {
                ...
                //MessageBox.Show(LeaserID);
              
                conn.Open();
                MySqlDataReader dr1 = null;
                
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM leasing_details WHERE VehicleNumber =" + LeaserID + ";", conn);
                ...
                try
                {
                    ...
                    while (dr1.Read())
                    {
                        ...
                        txt_Lname.Text = dr1[0].ToString();
                        comboBox1VechileNo.Text = dr1["VehicleNumber"].ToString();
                        txt_Lname.Text = dr1["LeaserName"].ToString();
                        txt_Laddress.Text = dr1["LeaserAddress"].ToString();
                        txt_phoneNo.Text = dr1["PhoneNumber"].ToString();
                        ...
                        datePicLstart.Text = dr1["StartDate"].ToString();
                        datePicLstart.Text = dr1["StartDate"].ToString();
                        txt_interstRate.Text = dr1["Interestrate"].ToString();
                        txt_intialPay.Text = dr1["InitialPayement"].ToString();
        ...
        private void btn_updateS_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                try
                {
                    ...
                    string Query = null;
                    Query = "UPDATE from_suppliers SET SupplierName = @SupplierName,SupplierAddress = @SupplierAddress,Date = @Date,Time=@Time,StockWeight = @StockWeight,NoOfTurn = @NoOfTurn,VehicleNumber = @VehicleNumber,Staffid = @Staffid,Distance=@Distance,costPerKm=@costPerKm,totCost=@totCost WHERE VehicleNumber = @VehicleNumber";
            ...
            try
            {
                ...
                while (dr.Read())
                {
                   ...
                   */
                    ...
                    //datePicLstart.Text = dr["StartDate"].ToString();
                    //datePicLstart.Text = dr["StartDate"].ToString();
                    datePicService.Text = dr["ServiceDate"].ToString();
                    datePickerNextServiceDate.Text = dr["NextSerDate"].ToString();
        ...
        private void dgvCustomer_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    conn.Open();
            //    MySqlDataReader dr = null;
            //    MySqlCommand cmd = new MySqlCommand("SELECT c.address1 as Company,d.address as Address,i.deliverDate as DeliveryDate,d.phoneNo as PhoneNo FROM customer c,invoice i,deliverydetails d");
            ...
            //            //txt_Cname.Text = dr["c.address1"].ToString();
            ...
            //            txt_cAddress.Text = dr["address"].ToString();
            //            datePicC.Text = dr["Date"].ToString();
        ...
        private void btn_updateC_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                try
                {
                    ...
                    string Query = null;
                    Query = "UPDATE to_customers SET CustomerName=@CustomerName,CustomerAddress= @CustomerAddress,Date =@Date,Time=@Time,StockWeight=@StockWeight,NoOfTurn=@NoOfTurn,VehicleNumber=@VehicleNumber,Staffid=@Staffid WHERE VehicleNumber=@VehicleNumber,@Distance=Distance,@costPerKm=costPerKm,@totCost=totCost";
        ...
        private void dgvSuppliers_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //        // cmd.Parameters.Add("@Time", MySqlDbType.VarChar).Value = txt_Time.Text;
            //        datePicS.Text = dr["Date"].ToString();
        ...
        private void bttn_balance_Click(object sender, EventArgs e)
        {
            ...
            //do calculations
            double costrate = cost * ((100-intrestRate) / 100);
        ...
        private void dgvVechicle_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        {
            string distance = Convert.ToString(txt_cAddress.Text);
            Vechicle_Mgt v = new Vechicle_Mgt();
            textBoxdistanceC.Text=v.getDistance("Kollupitiya", distance).ToString();
        }

        private void dgvCustomer_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow row = this.dgvCustomer.Rows[e.RowIndex];
            txt_Cname.Text=row.Cells[0].Value.ToString();
            txt_cAddress.Text = row.Cells[1].Value.ToString();
            // datePicC.Text = row.Cells[2].Value.ToString();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            double distance = 0, costperKm = 0, totalCost= 0;

            //read input fromm user

            distance = double.Parse(textBoxdistanceC.Text);
            costperKm = double.Parse(textBoxCostKm.Text);

            //calculations
            totalCost = costperKm * (distance / 1000);

            //display results
            textBoxCostC.Text = totalCost.ToString();
        }
        ...
        private void dgvSuppliers_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtSname.Text = row.Cells[0].Value.ToString();
            txtsAddress.Text = row.Cells[1].Value.ToString();
        }

        private void button8_Click(object sender, EventArgs e)
        {
            string distance = Convert.ToString(txtsAddress.Text);
            Vechicle_Mgt v = new Vechicle_Mgt();
            textBoxDisSup.Text = v.getDistance("Kollupitiya", distance).ToString();
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            distance = double.Parse(textBoxDisSup.Text);
            costperKm = double.Parse(textBoxCostPerKmSup.Text);

            //calculations
            totalCost = costperKm * (distance / 1000);

            //display results
            textBoxTotCostSup.Text = totalCost.ToString();
        }

        private void button2_Click(object sender, EventArgs e)
        {
            EwingInventory.ReportForms.rptfrm_Leasingcs cr = new EwingInventory.ReportForms.rptfrm_Leasingcs(dtp1.Value.ToString("yyyy-MM-dd"));
            cr.Show();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            EwingInventory.ReportForms.rptfrm_service fr = new EwingInventory.ReportForms.rptfrm_service(dtpNsd.Value.ToString("yyyy-MM-dd"));
            fr.Show();
        }

        private void button11_Click(object sender, EventArgs e)
        {
            EwingInventory.ReportForms.rptfrm_Ncost1 fr = new EwingInventory.ReportForms.rptfrm_Ncost1();
            fr.Show();
        }

        private void button12_Click(object sender, EventArgs e)
        {
            EwingInventory.ReportForms.rptfrm_Ncost2 fr = new EwingInventory.ReportForms.rptfrm_Ncost2();
            fr.Show();
        }

        private void dgvLeasing_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            //comboBox1VechileNo.Text = dr["VehicleNumber"].ToString();
            ...
            ////DataGridViewRow row = this.dgvLeasing.Rows[e.RowIndex];
            ////comboBox1VechileNo.Text = row.Cells[0].Value.ToString();
            ////txt_Lname.Text = row.Cells[1].Value.ToString();
            ////txt_phoneNo.Text = row.Cells[2].Value.ToString();
            ////datePicLstart.Text = row.Cells[1].Value.ToString();
            ////txt_interstRate.Text = row.Cells[1].Value.ToString();
            ////txt_intialPay.Text = row.Cells[1].Value.ToString();
        }

        private void dgvLeasing_MouseClick(object sender, MouseEventArgs e)
        {
            MySqlConnection conn = new MySqlConnection(connString);
