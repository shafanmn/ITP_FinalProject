...
namespace EwingInventory
{
    public partial class frm_users : Form
    {
        ...
        {
            ReportForms.rptfrmAtt u = new ReportForms.rptfrmAtt(this.currentUID);
            u.Show();
        }
        ...
        {
            ReportForms.rptfrmStaffDetails st = new ReportForms.rptfrmStaffDetails();
            st.Show();
        }
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            if (cbAll.Checked)
            {
                ...
                cbAppr.Enabled = false;
                cbPending.Enabled = false;
                cbRej.Enabled = false;
            }else
            {
                cbAppr.Checked = false;
        ...
        private void checkBox4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                cbLoan.Checked = true;
                cbSalAdv.Checked = true;
                cbHd.Checked = true;
                cbDoff.Checked = true;
                button9.Enabled = true;

                cbLoan.Enabled = false;
                cbSalAdv.Enabled = false;
                cbHd.Enabled = false;
                cbDoff.Enabled = false;
            }
            else
            {
                cbLoan.Checked = false;
                cbSalAdv.Checked = false;
                cbHd.Checked = false;
                cbDoff.Checked = false;
                button9.Enabled = false;

                cbLoan.Enabled = true;
                cbSalAdv.Enabled = true;
                cbHd.Enabled = true;
                cbDoff.Enabled = true;
            }
        }
