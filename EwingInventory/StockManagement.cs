...
namespace EwingInventory
{
    public partial class StockManagement : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            string mmsql = "select item.itemCode , reorderlevel.reOrderPoint , item.Discription from reorderlevel,item where reorderlevel.itemCode=item.itemCode and (item.itemCode like '%" + textBox2.Text + "%'OR item.Discription like '%" + textBox2.Text + "%') ";
            cmd = new MySqlCommand(mmsql, con);
        ...
        {
            AssestReport ar = new AssestReport();
            ar.Show();
        }

        private void button6_Click(object sender, EventArgs e)
        {
            ReOrderLevelReport r = new ReOrderLevelReport();
            r.Show();
        }
