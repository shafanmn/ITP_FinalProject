...
namespace EwingInventory
{
    public partial class form_ManufactMgt : Form
    {
        ...
        //        while (read.Read())
        //            //comboBoxjobs.Items.Add(read.GetString("jobName"));
        ...
        { string stat = comboBoxtoorder.ToString();
             if(!text_ID.Text.Equals(""))
            //if (stat == "YES")
                ...
                { 
                    ...
                    string touser = "thananjaje3@gmail.com";
                    string message2 = "An Order has been placed!";
                    Send_Message em = new Send_Message();
                    em.email(touser, message2);
        ...
        private void mdgv_production2_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            comboBoxjobs.Text = mdgv_production2.CurrentRow.Cells[1].Value.ToString();
        ...
        private void mdgv_production1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    comboBoxjobs.Text = dr["currentJob"].ToString();
        ...
        private void mdgv_manufactraw5_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            textBoxjobid.Text = mdgv_manufactraw5.CurrentRow.Cells[0].Value.ToString();
            string st = mdgv_manufactraw5.CurrentRow.Cells[6].Value.ToString();
            ...
            if (st == "Disable")
            {
                ...
                textBoxdura.Enabled = false;
                dateTimePickersdate.Enabled = false;
                textBoxempass.Enabled = false;
            }
            else
            {
                ...
                textBoxdura.Enabled = true;
                dateTimePickersdate.Enabled = true;
                textBoxempass.Enabled = true;
            }
            ...
            //    conn.Open();
            //    MySqlDataReader dr = null;
            //    MySqlCommand cmd = new MySqlCommand("SELECT * FROM jobs WHERE jobid =" + comboBoxjobsid.Text + ";", conn);
            ...
            //        comboBoxjobstitle.Text = dr["jobName"].ToString();
            //        textBoxdesc.Text = dr["description"].ToString();
            //        textBoxdura.Text = dr["duration"].ToString();
            //        textBoxempass.Text = dr["noOfEmp"].ToString();
            //        dateTimePickersdate.Value = new DateTime(Convert.ToInt32(dr[0]), Convert.ToInt32(dr[1]), Convert.ToInt32(dr[2]));
        ...
        {
            int A = Convert.ToInt32(text_stock.Text);
            int B = Convert.ToInt32(text_ROL.Text);
            string msg ="In Stock Amount should be grater than ROL!";
        ...
        {
            if (textBoxbatchno.Text != "" && comboBoxjobs.Text != "")
            {
                //SQL STMT
        ...
        {
            padd(textBoxbatchno.Text, comboBoxjobs.Text, textBoxnoofemp.Text, textBoxworkinghrs.Text, textBoxnoofunits.Text, textBoxcostperunit.Text, textBoxtotcost.Text);
            Loadtable(mdgv_production2, "SELECT batchNo 'Barch No', currentJob 'Job', noOfEmp 'No Of Employees', workingHrs 'Working Hrs', costPerUnit 'Cost Per Unit', units 'No Of Units', total 'Total Costs' FROM `batch`");
            Loadtable(mdgv_production1, "SELECT batchNo 'Barch No', currentJob 'Job' FROM `batch`");
        }
        ...
        private void Update(string id, string nam, string an, string ro, string oa, string to)
        {
            //int A = Convert.ToInt32(text_stock.Text);
            //int B = Convert.ToInt32(text_ROL.Text);
            //string message2 = text_name.Text + " has been ordered " + text_OA.Text;
            //string message1 = text_name.Text + " In Stock is lower than ROL!";
        ...
        private void dataGridViewMonitor_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            string st = dataGridViewMonitor.CurrentRow.Cells[4].Value.ToString();
            ...
            {
                textBoxitemNo.Enabled = true;
                textBoxitemName.Enabled = true;
                textBoxtotqty.Enabled = true;
                datePickerdeliverdate.Enabled = true;
                comboBoxdeliverstatus.Enabled = true;
            }
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    datePickerdeliverdate.Text = dr["deliverDate"].ToString();
        ...
        {
            pUpdate(textBoxbatchno.Text, comboBoxjobs.Text, textBoxnoofemp.Text, textBoxworkinghrs.Text, textBoxnoofunits.Text, textBoxcostperunit.Text, textBoxtotcost.Text);
            Loadtable(mdgv_production2, "SELECT batchNo 'Barch No', currentJob 'Job', noOfEmp 'No Of Employees', workingHrs 'Working Hrs', costPerUnit 'Cost Per Unit', units 'No Of Units', total 'Total Costs' FROM `batch`");
            Loadtable(mdgv_production1, "SELECT batchNo 'Barch No', currentJob 'Job' FROM `batch`");
        }
        ...
        //                while (reader.Read())
        //                {
        //                    comboBoxjobs.Items.Add(reader.GetString("jobId"));
        //                }
        //            }
        //        }
        ...
        {
            {
                ...
                using (var command = new MySqlCommand(query, conn))
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        ...
                        comboBoxjobs.Text = reader.GetInt32("jobId").ToString();
                        //comboBoxjobs.Text = reader.GetString("jobName");
                    }
                }
            }
        }

        private void tabPage_Report_Click(object sender, EventArgs e)
        {
        ...
        {
            ReportForms.rptfrm_batch rp = new ReportForms.rptfrm_batch();
            rp.Show();
        }
        ...
        //{
        //    jobs();
        //    var jn = Convert.ToInt32(comboBoxjobs.Text);
        //    LoadjobDetailsByjobName(jn);

        //}

        //private void comboBoxjobs_TextChanged(object sender, EventArgs e)
        //{
        //    string filter = comboBoxjobs.Text;
        ...
        public void LoadJobs()
        {
            ...
            string query = "select jobName from jobs";
            MySqlCommand cmd = new MySqlCommand(query, conn);
            try
            {
        ...
        private void tabPage2_Production_MouseClick(object sender, MouseEventArgs e)
        {
            //clearTxts();
            LoadJobs();
        }

        private void comboBoxjobs_DropDown(object sender, EventArgs e)
        {
        ...
        {
            ReportForms.rptfrm_jobs1 cr = new ReportForms.rptfrm_jobs1(dtpJobs1from.Value.ToString("yyyy-MM-dd"), dtpJobs1to.Value.ToString("yyyy-MM-dd"));
            cr.Show();
        }

        private void button8_Click_1(object sender, EventArgs e)
        {
            CRForm3 cr = new CRForm3();
            cr.Show();
        }

        private void button6_Click(object sender, EventArgs e)
        {
            ManufactRForm cr = new ManufactRForm();
            cr.Show();
        }

        private void button7_Click(object sender, EventArgs e)
        {
            ReportForms.rptfrm_RM2 rp = new ReportForms.rptfrm_RM2();
            rp.Show();
        }

        private void button12_Click(object sender, EventArgs e)
        {
            //            ReportForms.rptfrm_ManufactItem1 rp = new ReportForms.rptfrm_ManufactItem1(dtpMI1.Value.ToString("yyyy-MM-dd"), dtpMI2.Value.ToString("yyyy-MM-dd"), comboBox_MI.Text);
            ReportForms.rptfrm_ManufactItem1 rp = new ReportForms.rptfrm_ManufactItem1(dtpMI1.Value.ToString("yyyy-MM-dd"), dtpMI2.Value.ToString("yyyy-MM-dd"));
            rp.Show();
        }

        private void button11_Click(object sender, EventArgs e)
        {
            ReportForms.rptfrm_ManufactItem2 rp = new ReportForms.rptfrm_ManufactItem2(comboBox_MI.Text);
            rp.Show();
        }

        private void button13_Click(object sender, EventArgs e)
        {
            ReportForms.rptfrm_empass rp = new ReportForms.rptfrm_empass();
            rp.Show();
        }
        ...
        class Send_Message
        {
            ...
            private string from = "ewingassoc@gmail.com";

            string subject = "EWing Associates ROL";
            ...
            public void email(string to, string message)
            {
                try
                {
                    ...
                    client.Credentials = new System.Net.NetworkCredential(from, "ewingass");
                    client.Send(mail);
        ...
        public string getemail()
        {
           ...
           // MessageBox.Show(userName);
            ...
            try
            {
                conn.Open();
                MySqlDataReader dr = null;
                MySqlCommand cmd = new MySqlCommand("SELECT email FROM staff WHERE  uName = '" + userName + "';", conn);
