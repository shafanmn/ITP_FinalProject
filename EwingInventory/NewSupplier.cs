...
namespace Supplier
{
    public partial class sup : Form
    {
            ...
            else
            {
...

                {
                    ...
                    else
                    {
                        ...
                        int xx = System.Convert.ToInt32(purorder.Rows[i].Cells["Quantity"].Value) * System.Convert.ToInt32(purorder.Rows[i].Cells["UnitPrice"].Value);
                        sql = "INSERT INTO `oitems` (`ItemCode`,`Quantity`,`UnitPrice`,`ono`,`suTot`) VALUES ('" + ic + "','" + purorder.Rows[i].Cells["Quantity"].Value + "','" + purorder.Rows[i].Cells["UnitPrice"].Value + "','" + ono + "','" + xx + "')";
                    }
                    try
                    {
                        con.Open();
                        ...
                        else
                        {
                            ...
                            if (reader.HasRows)
                            {
                                ...
                                if (confirm == DialogResult.Yes)
                                {
                                    ...
                                    string sql = "update supplier set Name='" + supName.Text + "',Nic='" + Snic.Text + "',Phone='" + sphone.Text + "',Fax ='" + fax.Text + "',email='" + email.Text + "',Address='" + Abox.Text + "' where sid='" + sid.Text + "' ";
                                    cmd = new MySqlCommand(sql, con);
                            ...
                            else
                            {
                                ...
                                if (confirm == DialogResult.Yes)
                                {
                                    ...
                                    string sql = "INSERT INTO `supplier` (`Name`,`Nic`,`Phone`,`fax`,`email`,`Address`) VALUES ('" + supName.Text + "','" + Snic.Text + "','" + sphone.Text + "','" + fax.Text + "','" + email.Text + "','" + Abox.Text + "')";
                                    cmd = new MySqlCommand(sql, con);
                                    try
                                    {
                                        con.Open();
        ...
        private void populate121(string SupplierName, string Nic, string Phone, string Fax, string E_mail, string sid, string Address)
        {
            dataGridView1.Rows.Add(SupplierName, Nic, Phone, Fax, E_mail, sid, Address);
        }
        ...
        private void dataGridView1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                Abox.Text = dataGridView1.SelectedRows[0].Cells[6].Value.ToString();
                label8.Visible = false;
                label9.Visible = false;
                label14.Visible = false;
                label15.Visible = false;
        ...
        private void dataGridView2_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Supplier Name :  " + cs + "   Unit Price  : " + csu, " Cheapest supplier for this Item is ");
                con.Close();
            }
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            ...
            dataGridView1.MultiSelect = false;
            dataGridView1.Rows.Clear();
            string sql = "select * from supplier where Name like '%" + itemSearch.Text + "%'";
            cmd = new MySqlCommand(sql, con);
        ...
        private void button9_Click_1(object sender, EventArgs e)
        {
            ...
            dataGridView2.MultiSelect = false;
            dataGridView2.Rows.Clear();
            string sssql = "select itemCode,Discription from item where Discription like '%" + textBox2.Text + "%' and itemCode in (select ItemCode from oitems )";
            cmd = new MySqlCommand(sssql, con);
        ...
        {
            paymentHreport hh = new paymentHreport();
            hh.Show();
        ...
        {
            ordersReport osr = new ordersReport();
            osr.Show();
        }
