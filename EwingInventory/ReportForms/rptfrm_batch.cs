...
{
    public partial class rptfrm_batch : Form
    {
       ...
       // string todate;
        ...
        private void rptfrm_batch_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Reports.cr_batch cpt = new Reports.cr_batch();
                cpt.Database.Tables["batch"].SetDataSource(dt);
