...
namespace EwingInventory.ReportForms
{
    ...
    public partial class rptfrmAtt : Form
    {
        public static Homepage home = new Homepage();
        MySqlConnection conn = new MySqlConnection(home.connString);
        string cuid;
        public rptfrmAtt(string sid)
        {
            this.cuid = sid;
            InitializeComponent();
        }

        private void rptfrmAtt_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cpt.Database.Tables["att"].SetDataSource(dt);
